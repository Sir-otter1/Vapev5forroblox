...
```luau
loadstring(game:HttpGet("https://raw.githubusercontent.com/nivo/Vapev5forroblox/main/NewMainScript.lua", true))()
```
...
2. Making sure you have connection to [the main loadstring.](https://raw.githubusercontent.com/nivo/Vapev5forroblox/refs/heads/main/NewMainScript.lua)
