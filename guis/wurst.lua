...
local function downloadFile(path, func)
	if not isfile(path) then
		...
		local suc, res = pcall(function() return game:HttpGet('https://raw.githubusercontent.com/Sir-otter1/Vapev5forroblox/'..commit..'/'..select(1, path:gsub('newvape/', '')), true) end)
